...
begin
    ...
    begin
        ...
        assert ALUCONTROL = B"0000"  and REGWR = '1' and
        ...
        assert ALUCONTROL = B"0001"  and REGWR = '1' and
        ...
        assert ALUCONTROL = B"0000"  and REGWR = '0' and
                 ALUSRC = '1' and MEMREAD = '0' and
        ...
        assert ALUCONTROL = B"0001"  and REGWR = '0' and
                 ALUSRC = '0' and MEMREAD = '0' and
        ...
        assert ALUCONTROL = B"0010" and REGWR = '1' and
                 ALUSRC = '0' and MEMREAD = '0' and
                 MEMWRITE = '0' and MEMTOREG = B"00" and BRANCH = '0' and
                 JUMP = '0' and JALRSRC = '0'
        ...
        assert ALUCONTROL = B"0011" and REGWR = '1' and
                 ALUSRC = '0' and MEMREAD = '0' and
                 MEMWRITE = '0' and MEMTOREG = B"00" and BRANCH = '0' and
                 JUMP = '0' and JALRSRC = '0'
        ...
        assert ALUCONTROL = B"0100" and REGWR = '1' and
                 ALUSRC = '0' and MEMREAD = '0' and
                 MEMWRITE = '0' and MEMTOREG = B"00" and BRANCH = '0' and
                 JUMP = '0' and JALRSRC = '0'
